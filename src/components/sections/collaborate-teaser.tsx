...
import { collaborateTeaserCopy } from "@/content/site-content";
...
export function CollaborateTeaser() {
  ...
  return (
    <section id={collaborateTeaserCopy.id} className="py-16 md:py-24 relative">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <p className="text-sm font-inter font-light tracking-widest uppercase text-foreground/70 mb-3">
            {collaborateTeaserCopy.subtitle}
          </p>
          <h2
            className={cn(
          ...
          >
            {collaborateTeaserCopy.ctaLabel}
